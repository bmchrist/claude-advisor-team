...
`Grade` (select: A/A-/B+/B/B-/C+/C/C-/D+/D/F — grades Merit only; see
Executive STEP 2), `Grade driver` (text), `Technical Confidence` / `Commercial Confidence`
(selects: C1/C2/C3/C4/C5 — evidence stage on each axis; see Executive STEP 1B),
